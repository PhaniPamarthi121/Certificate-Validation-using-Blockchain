   ...
   <h2><b>Upload Certificate to Blockchain Screen</b></h2>
	...
	if(res != null){
		out.println("<center><font face=verdana color=red>"+res+"</center></font>");
			...
			<th>Address</th><th>Details</th><th>Verified Date</th><th>Hash Code</th><th>Certificate Type</th><th><font size="" color="yellow">Image</font></th><th><font size="" color="yellow">Upload To Blockchain</font></th>
			</tr>
	<%
	...
	if(tmpfile.exists()) {
		...
		for(int i=0;i<list.size();i++){
			...
			<%if(cc.getHashcode().equals("none")){%>
			<td><a href="UploadBlockchain?t1=<%=cc.getID()%>"><font size="3" color="yellow">Click Here</a></td>
			<%} else {%>
				<td><font size="3" color="yellow">Done</td>
